...
# train_dir = "C:/Users/j.elachkar/Desktop/Train_mk"
...
# train_ds=train_gen.flow_from_directory(train_dir,target_size=(224,224),class_mode='binary')
...
#     st.write("The data is augmented so the model can generalize better on the unseen images, the plan is to avoid overfitting, the data augmentation includes: rotation range of 20%, width shift range, height shift range,horizontal flip and vertical flip. **Images will look blurry**")
#     st.write("")
#     col1,col2,col3 = st.columns(3)
